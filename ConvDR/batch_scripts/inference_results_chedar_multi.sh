...
python drivers/run_chedar_inference.py  --model_path=checkpoints/convdr-multi-cast19-chedar \
                                        ...
                                        --output_file=results/cast-19/multi_chedar.jsonl \
                                        --output_trec_file=results/cast-19/multi_chedar.trec \
                                        --model_type=rdot_nll \
