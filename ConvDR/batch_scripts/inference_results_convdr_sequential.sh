...
#SBATCH --gres=gpu:1
#SBATCH --job-name=convdr_seq_inference
#SBATCH --ntasks=1
...
python drivers/run_convdr_inference.py  --model_path=checkpoints/convdr-multi-cast19-convdr-sequential \
                                        --eval_file=datasets/cast-19/SORTED_eval_topics.rank.jsonl \
                                        --query=no_res \
                                        ...
                                        --output_file=results/cast-19/multi_convdr_seq.jsonl \
                                        --output_trec_file=results/cast-19/multi_convdr_seq.trec \
                                        --model_type=rdot_nll \
