...
NAME="checkpoints/chedar-ranking-cast19-m5"
python drivers/run_chedar_train_GRU.py  --output_dir=$NAME  \
                                    ...
                                    --learning_rate=1e-5 \
                                    --log_dir=logs/chedar-ranking-cast19-m5   \
                                    --num_train_epochs=16  \
                                    --model_type=rdot_nll  \
                                    --cross_validate  \
...
#
#python drivers/run_chedar_inference.py  --model_path=checkpoints/chedar-kd-cast19-m5 \
