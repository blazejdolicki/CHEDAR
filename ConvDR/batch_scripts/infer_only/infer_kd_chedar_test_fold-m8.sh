...
python drivers/run_chedar_inference_GRU.py  --model_path=checkpoints/chedar-kd-cast19-m8 \
                                        ...
                                        --output_file=results/cast-19/kd_chedar-test_fold-m8.jsonl \
                                        --output_trec_file=results/cast-19/kd_chedar-test_fold-m8.trec \
                                        --model_type=rdot_nll \
...
./trec_eval -m ndcg_cut.3 -m recip_rank ../CHEDAR/ConvDR/datasets/cast-19/qrels.tsv ../CHEDAR/ConvDR/results/cast-19/kd_chedar-test_fold-m8.trec > ../CHEDAR/ConvDR/results/cast-19/kd_chedar-test_fold-m8.txt
