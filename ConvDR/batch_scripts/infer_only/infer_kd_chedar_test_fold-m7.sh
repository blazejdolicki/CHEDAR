...
python drivers/run_chedar_inference.py  --model_path=checkpoints/chedar-kd-cast19-m7 \
                                        ...
                                        --output_file=results/cast-19/kd_chedar-test_fold-m7.jsonl \
                                        --output_trec_file=results/cast-19/kd_chedar-test_fold-m7.trec \
                                        --model_type=rdot_nll \
...
./trec_eval -m ndcg_cut.3 -m recip_rank ../CHEDAR/ConvDR/datasets/cast-19/qrels.tsv ../CHEDAR/ConvDR/results/cast-19/kd_chedar-test_fold-m7.trec > ../CHEDAR/ConvDR/results/cast-19/kd_chedar-test_fold-m7.txt
