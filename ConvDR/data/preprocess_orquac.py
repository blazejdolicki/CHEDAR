...
if __name__ == "__main__":
    ...
    passage_id_to_idx = {}
    with open(all_blocks, "r", encoding='utf-8') as f, open(collection, "w", encoding='utf-8') as g:
        idx = 0
        for line in tqdm(f):
            obj = json.loads(line)
    ...
    for target in targets:
        ...
        with open(train, "r", encoding="utf-8") as f, open(queries_manual, "w", encoding="utf-8") as g, open(
                cqr, "w", encoding='utf-8') as h, open(queries_raw, "w",encoding='utf-8') as i:
            responses = []
            last_dialog_id = None
            for line in f:
                obj = json.loads(line)
